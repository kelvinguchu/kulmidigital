...
const AboutMiddle3: React.FC = () => {
  ...
  const handleNext = () => {
    if (!isAnimating && startIndex < teamMembers.length - 3) {
      setIsAnimating(true);
    ...
    <section className='bg-white mt-[80px] py-[80px] px-6 md:px-12'>
      <div className='flex flex-col md:flex-row justify-between items-start md:items-center'>
        <div className='w-full md:w-[30%] mb-8 md:mb-0'>
          <div className='-mt-[100px]'>
            ...
            <p
              ...
              We are led by seasoned digital, business and tech minds with years
              of experience.
              <br />
              <br />
        ...
        <div className='w-full md:w-[60%] relative'>
              ...
              {teamMembers
                ...
                .map((member, index) => (
                  <motion.div
                    ...
                    style={{
                      left: `${index * 33.33}%`,
                      width: index === 2 ? "32%" : "33.33%",
                    }}>
                    <div className='h-full px-2'>
                      <TeamCard {...member} />
                      {index === 2 && startIndex < teamMembers.length - 3 && (
          ...
          {startIndex < teamMembers.length - 3 && (
            <button
              onClick={handleNext}
              disabled={isAnimating}
